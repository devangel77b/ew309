...
% Import the data
DeadZonepos = readtable("G:\My Drive\Courses\EW309 AY20\10. Turret System Modeling\10b. Dead Zone ID\DeadZone_neg.xlsx", opts, "UseExcel", false);
...
plot(time,pos)
hold on
plot(time(in1)*ones(1,10),linspace(-15,0,10),'-r')
