...
\newcommand{\hmwkDueDate}{February\ 26,\ 2019} % Due date
%\newcommand{\hmwkClass}{BIO\ 101} % Course/class
\newcommand{\hmwkClass}{ES309} % Course/class
...
\begin{enumerate}[(a)] % (a), (b), (c), ...
\item Demonstrate an understanding of the field
\item Increase the length of the document 
\item Convince the reader that you are not repeating an existing and fully documented project
...
What is the purpose of the component shown in Fig.1 (circle {\bf one})?
\begin{figure}[H]
\centering
...
What is the maximum output current rating for the component shown in Fig.~\ref{fig:MOSFET} (circle {\bf one})?
...
What is the purpose of the components shown in Fig. 2 (circle {\bf one})?
\begin{figure}[H]
\centering
...
\item Look nice in your firing circuit
\item Allow a forward path for the inductive motor current to flow when the circuit is opened
\end{enumerate}
