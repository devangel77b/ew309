...
% A designer should aim for a 50\% torque allowance for most industrial applications \cite{Stiffler}
\end{frame}
...
P = 
\end{equation}
%As a starting point, choose a motor with double the calculated power requirements \cite{Stiffler}
\end{frame}
